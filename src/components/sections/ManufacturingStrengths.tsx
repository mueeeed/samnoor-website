...
const STRENGTHS = [
  `${siteConfig.stats.factoryAreaSqFt.toLocaleString()} sq ft production facility in Dubai's Al Quoz Industrial Area`,
    ...
    <section className="py-20 sm:py-24">
      <Container className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-20">
        <div className="relative lg:order-2">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-sm shadow-[0_30px_70px_-35px_rgba(12,12,8,0.5)]">
